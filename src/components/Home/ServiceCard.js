...
const ServiceCard = ({cut}) => {
    ...
    return (
        <div className="grid gap-4 px-4 py-8 rounded hover:transition duration-500 ease-in-out bg-white text-black justify-center border-t-2 border-r-2 ">
            ...
            <button className="py-1 px-4 border-2 rounded uppercase font-bold m-5 border-c-main ">Buy Service</button>
        </div>
    );
};
